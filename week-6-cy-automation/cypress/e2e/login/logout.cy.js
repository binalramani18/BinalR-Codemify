describe('Logout', () => {
    ...
    it('Should log out', () => {
      ...
      cy.get('[class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-w5qhhs"]').click();
      cy.get('[class="MuiButtonBase-root MuiMenuItem-root MuiMenuItem-gutters css-p9n58v"]').click();
